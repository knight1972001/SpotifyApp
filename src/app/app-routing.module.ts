...
export const routingComponents = [AboutComponent, NotFoundComponent,NewReleasesComponent, AlbumComponent, ArtistDiscographyComponent, RegisterComponent, LoginComponent, FavouritesComponent];